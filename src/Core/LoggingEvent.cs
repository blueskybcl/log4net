...
namespace log4net.Core
{
...
#endif
	{
        ...
        public LoggingEvent(Type callerStackBoundaryDeclaringType, ILoggerRepository repository, string loggerName, Level level, object message,string appenderName, Exception exception)
        {
            m_callerStackBoundaryDeclaringType = callerStackBoundaryDeclaringType;
            m_message = message;
            m_repository = repository;
        ...
        private readonly string m_appenderName;

        public string AppenderName
        {
            get { return m_appenderName; }
        }
