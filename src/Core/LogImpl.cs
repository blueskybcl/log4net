...
namespace log4net.Core
{
	...
	public class LogImpl : LoggerWrapperImpl, ILog
	{
        ...
        virtual public void Info(object message, string appenderName)
        {
            Logger.Log(ThisDeclaringType, m_levelInfo, message, appenderName, null);
        }
        ...
        /// </remarks>
        /// <seealso cref="M:Info(object)"/>
        virtual public void Info(object message,string appenderName, Exception exception)
        {
            Logger.Log(ThisDeclaringType, m_levelInfo, message,appenderName, exception);
        }
